...
# ACCESSORS
    ...
    public function getLanguage() {
        return $this->_call($this->_sLanguage);
    }

    /**
     * SET LANGUAGE
     *
     * @param string|callable $sLanguage
     * @return $this
     */
    public function setLanguage($sLanguage) {
        return $this->_set($this->_sLanguage, $sLanguage);
    }
    ...
    public function getSubscriberCode() {
        return $this->_call($this->_mSubscriberCode);
    }

    /**
     * SET SUBSCRIBER CODE
     *
     * @param int|string|callable $mSubscriberCode
     * @return $this
     */
    public function setSubscriberCode($mSubscriberCode) {
        return $this->_set($this->_mSubscriberCode, $mSubscriberCode);
    }
